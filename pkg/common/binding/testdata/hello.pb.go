...
func (x *CrafterReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CrafterReq) ProtoMessage() {}

func (x *CrafterReq) ProtoReflect() protoreflect.Message {
	mi := &file_hello_proto_msgTypes[0]
...
// Deprecated: Use CrafterReq.ProtoReflect.Descriptor instead.
func (*CrafterReq) Descriptor() ([]byte, []int) {
	return file_hello_proto_rawDescGZIP(), []int{0}
}

func (x *CrafterReq) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
var file_hello_proto_goTypes = []interface{}{
	(*CrafterReq)(nil), // 0: hertz.CrafterReq
}
