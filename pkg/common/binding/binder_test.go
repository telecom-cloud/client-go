...
import (
	...
	"github.com/telecom-cloud/client-go/pkg/common/binding/testdata"
	"github.com/telecom-cloud/client-go/pkg/common/test/assert"
	"github.com/telecom-cloud/client-go/pkg/protocol"
	"github.com/telecom-cloud/client-go/pkg/protocol/consts"
	req2 "github.com/telecom-cloud/client-go/pkg/protocol/http1/req"
...
func TestBind_BindProtobuf(t *testing.T) {
	data := testdata.CrafterReq{Name: "crafter"}
	...
	result := testdata.CrafterReq{}
	err = DefaultBinder().BindAndValidate(req.Req, &result, nil)
	if err != nil {
		t.Error(err)
	}
	assert.DeepEqual(t, "crafter", result.Name)
